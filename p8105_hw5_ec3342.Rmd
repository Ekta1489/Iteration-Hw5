...
#Make a second plot (or overlay on the first) the average estimate of Beta_1 only in samples for which the null was rejected on the y axis and the true value of Beta_1 on the x axis. Is the sample average of Beta1_hat across tests for which the null is rejected approximately equal to the true value of Beta_1? Why or why not?
